...
class KDTreePartitioning:
    ...
    def save_partitions(self, datatype, depth, output_dir=f"temp/KD_tree", runtime=None, strategies_data=None,
                        percentage=None):
        """
        ...
        os.makedirs("temp/final/AR/kdtree/leftbiased", exist_ok=True)
